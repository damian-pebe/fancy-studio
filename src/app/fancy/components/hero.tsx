      ...
      <div className="w-full max-w-4xl mt-20 mx-auto flex justify-between items-center">
        <div className="text-black text-sm md:text-xl leading-relaxed font-poppins">
          <span className="md:hidden text-center">
            Somos FANCY®, un estudio especializado en microblading y técnicas
            avanzadas de belleza. Nos destacamos en la creación de cejas
            perfectamente definidas y extensiones de pestañas.
          </span>
          <span className="hidden md:block">
            Somos FANCY®, un estudio especializado en microblading y técnicas
            avanzadas de belleza. Nos destacamos en la creación de cejas
            perfectamente definidas, powder brows, shading, y extensiones de
            pestañas. Nuestro equipo de artistas expertos utiliza las técnicas
            más innovadoras y seguras para realzar tu belleza natural. Ya sea
            que busques un look natural o dramático, en FANCY® transformamos tus
            características faciales con precisión y arte.
          </span>
        </div>
      </div>
      <button
